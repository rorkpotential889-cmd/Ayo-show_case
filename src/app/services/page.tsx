...
const services = [
  ...
  },
  {
    ...
    description:
      'Build cross-platform mobile applications using FlutterFlow, React Native, and modern mobile frameworks. Create native-feeling apps with seamless user experiences.',
    tools: ['FlutterFlow', 'React Native', 'Flutter', 'Firebase', 'Expo'],
    mockupType: 'mobile' as const,
    mockupAlt: 'Mobile App Interface',
    mockupSrc: '/mockups/mobile-app.svg',
    features: [
      'Cross-platform apps',
      'Native performance',
      'User authentication',
  ...
  },
  {
    ...
    description:
      'Create intelligent chatbots and automation bots for customer support, workflow automation, and business process optimization. Integrate with popular platforms and APIs.',
    tools: ['OpenAI', 'Anthropic', 'Discord.js', 'Telegram Bot API', 'Slack API', 'Python'],
    mockupType: 'dashboard' as const,
    mockupAlt: 'Bot Interface',
    mockupSrc: '/mockups/ai-dashboard.svg',
    features: [
      'Chatbots',
      'Discord bots',
